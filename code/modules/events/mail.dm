...
/datum/event/mail/announce()
	command_announcement.Announce("Новая партия почты, адресованная сотрудникам Комплекса, поступила в сортировочный пункт и будет доставлена на следующем доступном шаттле снабжения.", pick("Major Bill's Shipping", "Flefingbridge Transport", "SolX Freight", "QuiCo. Mailing Services"), zlevels = affecting_z)
