...
/datum/event/disposals_explosion/announce()
	command_announcement.Announce("Показатели давления указывают на неизбежный взрыв системы трубопровода в \"[get_area(bursting_pipe)]\". Некоторые участки трубопровода могут быть повреждены.", "Атмосферные датчики Комплекса", zlevels = affecting_z)
